...
<body>
    <header>
        <div class="logo">Mantenimiento de Departamentos - Mostrar Departamento</div>
    </header>
    <main class="mainEditar">
        <div class="contenido">
            ...
            */
            ...
            ?>
            <form name="formulario" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" class="formularioMostrar">
                    <div>
